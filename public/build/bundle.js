...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$4, 21, 2, 454);
    			attr_dev(label1, "for", "gain");
    			attr_dev(label1, "class", "svelte-1dx4cdq");
    			add_location(label1, file$4, 28, 2, 593);
    			...
    			add_location(input1, file$4, 29, 2, 632);
    			attr_dev(button, "class", "calculate svelte-1dx4cdq");
    			add_location(button, file$4, 36, 2, 758);
    			attr_dev(p1, "class", "result svelte-1dx4cdq");
    			add_location(p1, file$4, 37, 2, 833);
    			attr_dev(div, "class", "card svelte-1dx4cdq");
    			add_location(div, file$4, 14, 0, 234);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input1, file$3, 29, 2, 753);
    			attr_dev(button, "class", "calculate svelte-1oauim1");
    			add_location(button, file$3, 36, 2, 896);
    			attr_dev(p1, "class", "result svelte-1oauim1");
    			add_location(p1, file$3, 39, 2, 1011);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t18 = text(t18_value);
    			attr_dev(h2, "class", "svelte-1oauim1");
    			add_location(h2, file$2, 23, 2, 442);
    			attr_dev(p0, "class", "description svelte-1oauim1");
    			add_location(p0, file$2, 24, 2, 484);
    			attr_dev(label0, "for", "ev");
    			attr_dev(label0, "class", "svelte-1oauim1");
    			add_location(label0, file$2, 28, 2, 618);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "id", "ev");
    			attr_dev(input0, "placeholder", "Ingrese el valor ganado");
    			attr_dev(input0, "class", "svelte-1oauim1");
    			add_location(input0, file$2, 29, 2, 664);
    			attr_dev(label1, "for", "pv");
    			attr_dev(label1, "class", "svelte-1oauim1");
    			add_location(label1, file$2, 36, 2, 778);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "id", "pv");
    			attr_dev(input1, "placeholder", "Ingrese el valor planificado");
    			attr_dev(input1, "class", "svelte-1oauim1");
    			add_location(input1, file$2, 37, 2, 829);
    			attr_dev(label2, "for", "ac");
    			attr_dev(label2, "class", "svelte-1oauim1");
    			add_location(label2, file$2, 44, 2, 948);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "id", "ac");
    			attr_dev(input2, "placeholder", "Ingrese el costo actual");
    			attr_dev(input2, "class", "svelte-1oauim1");
    			add_location(input2, file$2, 45, 2, 994);
    			attr_dev(button, "class", "calculate svelte-1oauim1");
    			add_location(button, file$2, 52, 2, 1108);
    			attr_dev(p1, "class", "result svelte-1oauim1");
    			add_location(p1, file$2, 55, 2, 1193);
    			attr_dev(div, "class", "card svelte-1oauim1");
    			add_location(div, file$2, 22, 0, 420);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t0 = text("Site built by ");
    			strong = element("strong");
    			strong.textContent = "Isaac Bermudez Salguera";
    			t2 = text(", MBA student ULACIT 2025");
